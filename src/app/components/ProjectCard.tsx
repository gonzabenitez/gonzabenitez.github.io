...
const [mounted, setMounted] = useState(false);
  ...
  const isRecent = hasValidDate 
    ...
    : false;
  return (
    <div className="group relative flex flex-col rounded-3xl border border-white/5 bg-zinc-900/50 p-4 transition-all hover:border-cyan-500/50 hover:bg-zinc-900">
        ...
        <div>
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3 text-zinc-500">
              <a href={project.url} target="_blank" className="hover:text-white"><Github size={18} /></a>
              {project.demo && (
                <a href={project.demo} target="_blank" className="text-cyan-500 hover:text-cyan-300">
